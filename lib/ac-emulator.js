...
class ACEmulator {
  ...
  handleIncomingAP (pgn) {
    ...
    // would decode as genuine presses and drop the pilot to standby twice a second
    // for as long as commissioning mode is enabled. Named rather than silent: during
