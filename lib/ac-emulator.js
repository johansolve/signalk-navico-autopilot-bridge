...
class ACEmulator {
  ...
  sampleTrackBrg () {
    ...
    // destination without the bearing that belongs to it. Fixing the collinear case needs the leg's
    // IDENTITY tracked apart from its bearing, not another branch grafted onto the baseline.
  }
